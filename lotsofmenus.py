...
menuItem6 = MenuItem(
       ...
       It consists of Chinese-style wheat noodles served in
       a meat- or (occasionally) fish-based broth,
       often flavored
...
menuItem3 = MenuItem(
       ...
       with honey boba, jasmine tea jelly, grass jelly, caramel, cream,
...
menuItem4 = MenuItem(
       ...
       florets in a midly spiced soya,garlic sauce cooked
...
menuItem1 = MenuItem(
       ...
       onions and alllll those tasty Indian spices.
       Mmmm.""",
       price="$9.95",
       course="Entree",
       restaurant=restaurant1)
...
menuItem9 = MenuItem(
       ...
       description="""Fresh battered sirloin steak fried and smothered
       with cream gravy""",
       price="$8.99",
       course="Entree",
       restaurant=restaurant1)
...
menuItem4 = MenuItem(
       ...
       with a spicy mix(chilli, tamarind among others) and slow cooked
       in acylindrical clay or metal oven which
...
menuItem2 = MenuItem(
       ...
       name="Cachapa",
       description="""Golden
       brown, corn-based Venezuelan pancake; usually stuffed
